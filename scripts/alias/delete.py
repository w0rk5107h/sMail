...
if __name__ == '__main__':
    ...
    id = input(f'\n{Color.fg.cyan}[>] Enter the id of the alias that you want to delete: {Color.reset}')

    command_lines = [
        'mysql -u root',
        'USE mailserverdb;',
        f'DELETE FROM virtual_aliases WHERE id = {id};',
        'quit'
    ]
    _ = run_sql_query(command_lines, '[-] Error while deleting alias:')
    print(f'{Color.fg.green}[+] Alias deleted successfully.{Color.reset}')

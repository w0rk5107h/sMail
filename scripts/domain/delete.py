...
if __name__ == '__main__':
    ...
    id = input(f'\n{Color.fg.cyan}[>] Enter the id of the domain that you want to delete: {Color.reset}')

    command_lines = [
        'mysql -u root',
        'USE mailserverdb;',
        f'DELETE FROM virtual_domains WHERE id = {id};',
        'quit'
    ]
    _ = run_sql_query(command_lines, '[-] Error while deleting domain:')
    print(f'{Color.fg.green}[+] Domain deleted successfully.{Color.reset}')

...
if __name__ == '__main__':
    ...
    id = input(f'\n{Color.fg.cyan}[>] Enter the id of the user that you want to delete: {Color.reset}')

    command_lines = [
        'mysql -u root',
        'USE mailserverdb;',
        f'DELETE FROM virtual_users WHERE id = {id};',
        'quit'
    ]
    _ = run_sql_query(command_lines, '[-] Error while deleting user:')
    print(f'{Color.fg.green}[+] User deleted successfully.{Color.reset}')
